            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-5 text-white">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 text-center mb-10 gap-4 py-4">
                    ...
                    @foreach($Books as $Book)
                        <div
                            class="col-span-1 flex flex-col bg-gray-600 px-10 pt-5 pb-10 rounded-3xl hover:duration-300 hover:bg-white hover:text-black">
                            <a href="{{ url('/dashboard/' . $Book->categories[0]->slug . '/' . $Book->name) }}"
                               class="flex flex-col space-y-6">
                                <div>
                                    <span>
                                        {{ views($Book)->unique()->count() }}
