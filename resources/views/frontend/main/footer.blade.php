...
<footer class="px-7 text-white pb-5">
    <div class="hidden fixed opacity-90 left-0 bottom-[15%] md:bottom-[35%] overflow-hidden rounded-r-3xl" id="footerLang">
        <ul>
            <a href="/greeting/fa">
                <li class="bg-white p-5 md:px-7 duration-300 hover:bg-gray-700 text-black hover:text-white">fa</li>
            </a>
            <a href="/greeting/en">
                <li class="bg-white p-5 md:px-7 duration-300 hover:bg-gray-700 text-black hover:text-white">en</li>
            </a>
        </ul>
    </div>
    <div class="grid grid-cols-2 md:grid-cols-9 gap-y-5 md:gap-10 md:items-center py-4">
        <div class="col-span-1 md:col-span-3 flex justify-center items-center gap-2">
            ...
            <div>
                <h4 class="font-bold text-red-500">Find Us</h4>
